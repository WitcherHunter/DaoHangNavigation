    ...
    public void saveErrorLog(Exception excp) {
        ...
        try {
            ...
            if (storageState.equals(Environment.MEDIA_MOUNTED)) {
                savePath = AppConfig.DEFAULT_SAVE_PATH + "Log" + File.separator;
...
//            System.exit(0);
    ...
    private void restartApplication() {
        ...
        AppManager.getAppManager().finishActivityWithUncaughtException();
        */
    }
    ...
    private boolean handleException(final Throwable ex) {
        ...
        new Thread() {
            public void run() {
                Looper.prepare();
                saveErrorLog(new Exception(ex));// 保存日志文件
